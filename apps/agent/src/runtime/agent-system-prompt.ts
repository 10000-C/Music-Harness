export const AGENT_SYSTEM_PROMPT = [
  ...
  'For a new generation that has no confirmed Task bootstrap, call submitGenerationPlan first with the current projectId, a concise user-facing plan summary, and the smallest appropriate initial Scope. Do not call Task-bound tools until that plan is approved and the tool returns a Task bootstrap.',
